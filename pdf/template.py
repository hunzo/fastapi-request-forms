...
class PDF(FPDF):
    ...
    def __init__(self, form_title, form_subtitle, form_no, form_iso_no, **kwargs):
        ...
        print(os.path.join("media/fonts"))
        self.fonts_path = os.path.join("media/fonts")
        self.logo_path = os.path.join("media/logo")
        self.add_font(
            "prompt", "", f"{self.fonts_path}/Prompt-Regular.ttf", uni=True)
        self.add_font("th", "", f"{self.fonts_path}/THSarabunNew.ttf", uni=True)
        self.add_font("th", "B", f"{self.fonts_path}/THSarabunNew-Bold.ttf", uni=True)
    ...
    def header(self):
        ...
        self.image(f'{self.logo_path}/xlogo.jpg', 11, 20.8, 18)
